...
# @generated begin @mothership/maps-pre_installer - expo prebuild (DO NOT MODIFY) sync-00
  INVALID_$RNMBGL.pre_install(installer)
# @generated end @mothership/maps-pre_installer
end
...
# @generated begin @mothership/maps-post_installer - expo prebuild (DO NOT MODIFY) sync-001
  INVALID_$RNMBGL.post_install(installer)
# @generated end @mothership/maps-post_installer
end
